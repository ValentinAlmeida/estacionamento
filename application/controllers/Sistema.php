...
class Sistema extends CI_Controller{
    ...
    public function index(){
        ...
        $this->form_validation->set_rules('sistema_endereco', 'Endereço', 'trim|required|min_length[14]|max_length[145]');
        ...
        $this->form_validation->set_rules('sistema_site_url', 'Site Url', 'trim|required|valid_url|max_length[100]');
        $this->form_validation->set_rules('sistema_email', 'E-mail', 'trim|required|valid_email|max_length[100]');
        $this->form_validation->set_rules('sistema_texto_ticket', 'Texto ticket', 'trim|max_length[500]');
