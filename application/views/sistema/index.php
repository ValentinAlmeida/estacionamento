    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><?php echo(isset($sistema) ? '<i class="ik ik-calendar ik-2x"></i> &nbsp; Data da ultima alteração: &nbsp;'.formata_data_banco_com_hora($sistema->sistema_data_alteracao) : ''); ?></div>
                        <div class="card-body">
                            ...
                            <form class="forms-sample" name="form_index" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3 mb-20">
                                        ...
                                        <input type="text" class="form-control p_celphones" name="sistema_telefone_movel" value=" <?php echo(isset($sistema) ? $sistema->sistema_telefone_movel : set_value('sistema_telefone_movel')) ; ?> ">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12 mb-20">
                                        <label>Texto ticket de estacionamento</label>
                                ...
                                <button data-toggle="tooltip" title="Salvar" type="submit" class="btn btn-primary mr-2">Salvar</button>
